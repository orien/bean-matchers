...
public class HasValidImplGettersAndSettersExcludingMatcherTest {

    private HasValidImplGettersAndSettersExcludingMatcher unitUnderTest;
    ...
    public void beanWithValidGettersAndSettersShouldMatch() {
        ...
        unitUnderTest = new HasValidImplGettersAndSettersExcludingMatcher(valueGeneratorMock);
    ...
    public void beanWithInvalidSetterShouldMatchIfBadPropertyIsExcluded() {
        // given
        unitUnderTest = new HasValidImplGettersAndSettersExcludingMatcher(valueGeneratorMock, "badField");
        Object bean = new TestBeanWithBadSetter();
    ...
    public void shouldDescribeExpectationForExcludedProperties() {
        // given
        unitUnderTest = new HasValidImplGettersAndSettersExcludingMatcher(valueGeneratorMock, "excludedProperty");
